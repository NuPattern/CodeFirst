namespace NuPattern.Schema
{
    ...
    /// <summary>
    /// Provides visitor pattern support for the schema model.
    /// </summary>
    public interface IVisitableSchema
    {
        /// <summary>
        ...
        TVisitor Accept<TVisitor>(TVisitor visitor) where TVisitor : ISchemaVisitor;
    }
}